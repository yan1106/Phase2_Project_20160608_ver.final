...
<script type="text/javascript">
     ...
     $(function () {
        ...
        function reload(str1,str2,sign) {
            var str = "Imagebutton_" + str1 + "_" + str2;
            console.log(str);
        ...
        function test(str) {
           // alert('2');
            //var obj = document.getElementById("Image_stage_" + "PI1");
            //obj.src = "/icon/yellow.jpg";

            window.open("EP_TRA_Level.aspx?" + str);
...
<body>
    ...
    <asp:Panel ID="Panel_EPTRA" runat="server">
      ...
      <asp:LinkButton ID="Button_Cancel" runat="server" CausesValidation="False" style="position:fixed;"
      CommandName="Cancel" Text="取消" OnClick="Button_Cancel_Click"><img src="icon/Cancel.png" height="40px" width="40px" />
           ...
           <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;width:1500px;">
                 ...
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>　
                         <asp:Label ID="lab_Tra_12" runat="server"></asp:Label>
                         <asp:Panel ID="Panel_traLv_12" runat="server"></asp:Panel>                         
                     </td>
                     <td>　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_13" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="95">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_14" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_15" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_16" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_17" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="57">
                     ...
                     <td class="auto-style14">　<asp:Panel ID="Panel_traLv_18" runat="server">
                         </asp:Panel>
                     </td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_19" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_20" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_21" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_22" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="38">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_23" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_24" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_25" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_26" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_27" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_28" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_29" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_30" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_31" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_32" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_33" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_34" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_35" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_36" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_37" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_38" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_39" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="34">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_40" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_41" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="34">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_42" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_43" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_44" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td class="auto-style265">　<asp:Panel ID="Panel_traLv_45" runat="server">
                         </asp:Panel>
                     </td>
                 ...
                 <tr class="style-td-gray" height="42">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_46" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_47" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="42">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_48" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="42">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_49" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="42">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_50" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_51" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_52" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_53" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_54" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_55" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="38">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_56" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_57" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="44">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_58" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="42">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_59" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_60" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_61" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="42">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_62" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_63" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="42">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_64" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_65" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
